    ...
    <header className="absolute w-full top-0 flex flex-col gap-6 z-50">
      <div className="flex header-contact-bar text-white bg-[#334073] py-4 justify-center gap-8 noto">
        <a href="mailto:Info@abadnet.com.sa">
          ...
          >
            <g clip-path="url(#clip0_798_5106)">
              <g clip-path="url(#clip1_798_5106)">
                <path
        ...
        <a href="tel:+1 210 415 9856">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_798_5097)">
              <g clip-path="url(#clip1_798_5097)">
                <g clip-path="url(#clip2_798_5097)">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
        ...
        <a href="tel:+1 210 504 8191">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_798_5088)">
              <g clip-path="url(#clip1_798_5088)">
                <g clip-path="url(#clip2_798_5088)">
                  <path
