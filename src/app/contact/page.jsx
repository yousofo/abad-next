      ...
      <section className="detailed-contact flex flex-col md:flex-row gap-8 max-w-screen-xl mx-auto sm:mt-10 md:mt-16 lg:mt-20 xl:mt-28 px-4">
        <div className="text-[#151318] contact-info mx-auto">
          ...
          <p className="text-[#7B7584] text-xs sm:text-sm md:text-base">
            يمكنك التواصل معنا في اي وقت نحن متواجدين ٢٤ ساعة
          </p>
          <ul className="font-medium text-xs sm:text-sm md:text-base">
            <li>
              <a href="tel:+1 432 1234 234">
                <svg
                  width={24}
                  height={24}
                  viewBox="0 0 24 24"
                ...
                <span dir="ltr">+1 432 1234 234</span>
              </a>
            </li>
            <li>
              <a href="mailto:info@abadnet.com.sa">
                ...
                <span dir="ltr">info@abadnet.com.sa</span>
              </a>
            </li>
            <li>
              <svg
