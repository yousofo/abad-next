  ...
  return (
    ...
    >
      <div className="flex justify-between items-center px-5">
        ...
        <div onClick={()=>dispatch(toggleNavList())} className="flex items-center gap-1">
          <svg
            width="17"
            height="17"
            viewBox="0 0 17 17"
          ...
          >
            <g clip-path="url(#clip0_415_78451)">
              <path
      ...
      <ul className="text-[#424242]">
        <li className="font-[700]">
          <Link onClick={()=>dispatch(reset())} href="/">الرئيسية</Link>
        </li>
        <li>
        ...
        <li>
          <Link onClick={()=>dispatch(reset())} href="/articles">المقالات</Link>
        </li>
        <li>
          <Link onClick={()=>dispatch(reset())} href="/">الشركاء</Link>
        </li>
        <li>
          <Link onClick={()=>dispatch(reset())} href="/contact">تواصل معنا</Link>
        </li>
      </ul>
